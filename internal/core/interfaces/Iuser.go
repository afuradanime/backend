...
type UserService interface {
	...
	UpdatePersonalInfo(ctx context.Context, id int, email *string, username *string, location *string, pronouns *string, socials *[]string, birthday *time.Time, allowsFR, allowsRec *bool, avatarURL *string, acceptTerms *bool) error
